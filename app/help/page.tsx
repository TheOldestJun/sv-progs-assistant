      ...
      <div className="mt-8 space-y-8">
          ...
          <ul className="mt-4 space-y-3">
            <li className="rounded-lg border border-border bg-surface p-4">
              ...
              <p className="mt-1 text-sm text-text-secondary">
                ...
                «Мои заявки» (просмотр со статусами + отправка в работу + подтверждение получения)
                и «Создать пропуски». После одобрения заявки начальником снабжения заявитель
                может нажать «Отправить в работу» — заявка переходит в статус «Принято в работу»
                для отдела снабжения. Когда товар получен, заявитель подтверждает получение.
              </p>
            </li>
            <li className="rounded-lg border border-border bg-surface p-4">
              <strong className="text-foreground">Начальник снабжения</strong>
              <p className="mt-1 text-sm text-text-secondary">
                Создание новых заявок на снабжение. Одобрение новых заявок (перевод из
                «Ожидает одобрения» в «Одобрено»). Просмотр и управление статусами всех заявок.
              </p>
            </li>
            <li className="rounded-lg border border-border bg-surface p-4">
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <p className="mt-1 text-sm leading-relaxed text-text-secondary">
                ...
                если введённого названия нет в списке, нажмите Enter или выберите
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <p className="mt-1 text-sm leading-relaxed text-text-secondary">
                ...
                Кнопка «Сохранить в Excel» рядом скачивает заявку по шаблону
                (бланк заявки с подписью заявителя) с сохранением форматирования.
              </p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <p className="mt-1 leading-relaxed text-text-secondary">
            ...
            Новая заявка поступает на одобрение начальнику снабжения. После одобрения
            заявитель отправляет её в работу, и заявка переходит отделу снабжения.
            Дальнейшие статусы меняют сотрудники снабжения, склада и заявитель. Заявитель
            подтверждает получение товара. Завершающий статус — «Получено заказчиком»:
            после него изменение невозможно (кроме админа). Статусы «Получено на склад»
            и «Отправлено заявителю» — промежуточные, их продолжает менять склад.
        ...
        <section>
          ...
          <p className="mt-2 leading-relaxed text-text-secondary">
            Заявки архивируются автоматически, когда все её позиции получили статус
            «Получено заказчиком» (заявитель подтвердил получение).
        ...
        <section>
          ...
          <div className="mt-3 space-y-3">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              <h3 className="font-medium text-foreground">Ссылка для подтверждения</h3>
              <p className="mt-1 text-sm leading-relaxed text-text-secondary">
                После отправки заявителю для каждого пункта создаётся одноразовая ссылка.
                На вкладке «Ожидание подтверждения» отображаются все ссылки —
                их можно скопировать и отправить заявителю, если у него нет доступа
                к личному кабинету.
              </p>
            </div>
          </div>
          ...
          <div className="mt-3 space-y-3">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <p className="mt-1 text-sm leading-relaxed text-text-secondary">
                ...
                После подтверждения уведомление автоматически исчезает.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="mt-3 space-y-3">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <p className="mt-1 text-sm leading-relaxed text-text-secondary">
                ...
                Количество в пропусках выводится прописью на украинском языке.
              </p>
            </div>
          </div>
        </section>
