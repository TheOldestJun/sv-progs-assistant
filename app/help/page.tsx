        ...
        <section>
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <p className="mt-1 text-sm leading-relaxed text-text-secondary">
                Для каждой позиции укажите продукт, единицу измерения и количество.
                Продукты и единицы также можно создавать на лету через автокомплит с «+».
                Чтобы добавить новую строку, заполните текущую — появится кнопка
                «Добавить позицию».
              </p>
            </div>
            ...
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <p className="mt-1 text-sm leading-relaxed text-text-secondary">
                ...
                в таблице заявок в виде синей иконки рядом с названием продукта.
        ...
        <section>
          ...
          <div className="mt-4 space-y-3">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <p className="mt-1 text-sm leading-relaxed text-text-secondary">
                Нажмите на цветной бейдж статуса — откроется выпадающий список со всеми
                доступными статусами. Выберите нужный. Система запишет изменение в историю
                с указанием даты и имени сотрудника.
              </p>
            </div>
            <div className="rounded-lg border border-border bg-surface p-4">
              <h3 className="font-medium text-foreground">Просмотр истории</h3>
              <p className="mt-1 text-sm leading-relaxed text-text-secondary">
                Нажмите на название продукта в таблице — раскроется панель с историей
