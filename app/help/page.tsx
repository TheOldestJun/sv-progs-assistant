      ...
      <div className="mt-8 space-y-8">
        ...
        <section>
          ...
          <p className="mt-1 leading-relaxed text-text-secondary">
            ...
            подтверждает получение товара. Финальные статусы: «Получено на склад»,
            «Отправлено заявителю», «Получено заказчиком» — после них изменение
            невозможно (кроме админа). При смене статуса можно указать дату изменения
