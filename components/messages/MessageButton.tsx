 ...
 * Опрашивает /api/messages/unread-count через TanStack Query
 * (visibility-aware polling — пауза, когда вкладка скрыта)
 * Кнопка рендерится всегда (без сдвига шапки), бейдж появляется после загрузки данных
...
export function MessageButton() {
  ...
  // Бейдж показываем только когда данные загрузились (иначе сдвиг шапки)
