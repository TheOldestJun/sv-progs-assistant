/*
 * SupplyDeptDashboard — таблица заявок для отдела снабжения.
 * Показывает все заявки (с позициями), отсортированные по дате создания (свежие сверху).
 * Каждая позиция имеет статус выполнения, который можно менять через выпадающий список.
 */
"use client";
